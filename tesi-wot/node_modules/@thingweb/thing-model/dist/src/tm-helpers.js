...
class ThingModelHelpers {
    ...
    _getPartialTDs(model, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const modelInput = yield this.fetchAffordances(model, options);
            const extendedModels = yield this.composeModel(model, modelInput, options);
            return extendedModels;
        });
    }
    fetchAffordances(data, options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const modelInput = {};
            ...
            if (extLinks.length > 0) {
                ...
                for (const s of extLinks) {
                    ...
                    [source] = yield this._getPartialTDs(source, options);
